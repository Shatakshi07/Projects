...
parser.add_argument(
    ...
    default=10  # Set default value here
)
...
parser.add_argument(
    ...
    type=int,
    help="gpu index",
    default=1  # Set default value here
)
...
parser.add_argument(
    ...
    default='image'  # Set default value here
)
...
parser.add_argument(
    ...
    type=str,
    help="dataset name",
    default='DRIVE'  # Set default value here
)
...
train_dir="/home/shatakshig/V-GAN/data/{}/training/".format(dataset)
test_dir="/home/shatakshig/V-GAN/data/{}/test/".format(dataset)
