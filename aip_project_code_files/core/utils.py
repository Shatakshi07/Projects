...
DRIVEDataSetPath = '/home/shatakshig/aip_project_code_files/data/DRIVE'
STAREDataSetPath = '/home/shatakshig/aip_project_code_files/data/STARE'
CHASEDB1DataSetPath = '/home/shatakshig/aip_project_code_files/data/CHASEDB1'
#/home/shatakshig/aip_project_code_files/data/CHASEDB1
def get_data(dataset, img_name, img_size=256, gpu=True, flag='train'):
    ...
    for i in range(batch_size):
        ...
        imgGrey = img[:,:,2]  # Selecting only the red channel
        imgGrey = imgGrey[np.newaxis,:,:]
        img = np.transpose(img, [2, 0, 1])
        img = torch.from_numpy(img).float()
        imgGrey = torch.from_numpy(imgGrey).double()
