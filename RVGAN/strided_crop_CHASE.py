...
if __name__ == "__main__":
    ...
    # Creating maskss
    img_dir= "/home/shatakshig/RVGAN/CHASEDB1/images"
    ...
    for i in images:
        ...
        i = i.split('/')
        i = i[-1].split('.')
        img_name = "/home/shatakshig/RVGAN/CHASEDB1/images/"+i[0]+'.jpg'
        im = Image.open(img_name)
        img_arr = np.asarray(im)
        mask_name = "Chase_db1/training/mask/"+i[0]+"_mask.png"
        mask = Image.open(mask_name)
        mask_arr = np.asarray(mask)
        label_name = "/home/shatakshig/RVGAN/CHASEDB1/labels/"+i[0]+'_1stHO.png'
